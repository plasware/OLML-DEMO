...
def execute_create_dataset_stmt(stmt, table_dict):
    ...
    if os.path.exists(target_path):
        print("\033[0;33;40mDataset already exists.\033[0m")
    else:
        print("Dataset found.")
...
def execute_create_model_stmt(stmt, table_dict):
    ...
    """
    print("\033[0;33;40mSelecting model using fast model selection.\033[0m")
    ...
    """
    print("\033[0;33;40mChoose random model. Fast model selection is not used.\033[0m")
    print("\033[0;33;40mThis is supposed to be a comparison.\033[0m")
    base_model_name = 'Jeevesh8--init_bert_ft_qqp-24'
    print("\033[0;32;40mUsing %s as base model.\033[0m" % base_model_name)
